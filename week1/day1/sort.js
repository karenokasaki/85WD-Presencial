...
//se positivo, string comparada vem primeiro
// se negativo, string de referencia vem primeiro

const array = [15, 74, 65, 1];
const numberSorted = array.sort((a, b) => {
  console.log(`A is: ${a}. B is: ${b}. b - a : ${b - a}`);
  //quando a resposta for 0 não mexe em nada
  //quando a reposta for > 0 ... b vem antes
  //quando a resposta for < 0 ... a vem antes
